...
beforeEach(async () => {
    ...
    const sql1 = 'CREATE TABLE IF NOT EXISTS "measurements" ( `id` TEXT NOT NULL,  `name` TEXT NOT NULL, `unit` TEXT NOT NULL, `healthyupper` NUMBER NOT NULL, `healthylower` NUMBER NOT NULL )'
